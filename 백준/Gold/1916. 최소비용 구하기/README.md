...
### 출력 
 ...
 <p>오랜만에 다익스트라 다시 풀었는데 기본 문제라 그런지 기억이 잘 났다 현재 연결된 정점 탐색하고 갱신한 후 값이 최소인 정점으로 이동한는 과정을 계속 반복한다고 생각하자. 값이 최소인 정점을 뽑아내는 방법은 우선순위 큐를 이용하면 된다.</p>
